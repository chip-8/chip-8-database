...
function check(file) {
    ...
    try {
        ...
        console.error(indent(`𝘅 Could not parse ${databaseFile} as valid JSON:`, 1).red);
    ...
    try {
        ...
        console.error(indent(`𝘅 Could not parse ${schemaFile} as valid JSON:`, 1).red);
        console.error(indent(e.toString(), 2));
    }

    if (subject === undefined || schema === undefined)
        return false;
